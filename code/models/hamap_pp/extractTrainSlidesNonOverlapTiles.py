...
OUTPUT_PATH = "/fs/scratch/PAS1575/Pathology/CAMELYON16/nonOverlap/"
...
sampletotal, thresholds = get_slide_tiles()

df_thresh = pd.DataFrame(thresholds, columns=['slide_name','tissue_thresh'])
df_thresh.to_csv('train_tumor_slides_tissue_thresholds.csv', index=False)
