...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', metavar='--subfolder', type=str, action='store', 
                        ...
                        help='Tile set subfolder, e.g., tumor_001')
    ...
    data_path = osp.join('/fs/scratch/PAS1575/Pathology/CAMELYON16/nonOverlapTest', folder)
    ...
    if not osp.exists(data_path):
        ...
        output_path = data_path.replace('nonOverlapTest', 'nonOverlapTestStainNorm')  
