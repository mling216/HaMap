...
GAZE_MASK_PATH = '/fs/ess/PAS1575/Dataset/new_data/fixation_masks/optics/'
...
def main(seed, weight_threshold):
    # create output path
    output_path_train_tumor = '/fs/scratch/PAS1575/Pathology/CAMELYON16/extracted_tiles/train/tumor/optics_%s_s%d/' % (weight_threshold, seed)
    os.makedirs(output_path_train_tumor, exist_ok=True)
    output_path_train_normal = '/fs/scratch/PAS1575/Pathology/CAMELYON16/extracted_tiles/train/normal/optics_%s_s%d/' % (weight_threshold, seed)
    # os.makedirs(output_path_train_normal, exist_ok=True)

    output_path_val_tumor = '/fs/scratch/PAS1575/Pathology/CAMELYON16/extracted_tiles/validation/tumor/optics_%s_s%d/' % (weight_threshold, seed)
    os.makedirs(output_path_val_tumor, exist_ok=True)
    output_path_val_normal = '/fs/scratch/PAS1575/Pathology/CAMELYON16/extracted_tiles/validation/normal/optics_%s_s%d/' % (weight_threshold, seed)
